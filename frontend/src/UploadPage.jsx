  ...
  return (
    <Card className="w-full shadow-md min-h-screen">
      ...
      <CardContent>
        ...
        {uploading && (
          <div className="mt-6">
            <Card className="w-full max-w-md mx-auto bg-gradient-to-br from-blue-50/70 to-white/90 backdrop-blur-md shadow-lg border border-blue-100 animate-pulse">
              <CardHeader className="flex flex-col items-center">
                <Upload className="h-8 w-8 text-blue-600 animate-spin-slow" />
                <CardTitle className="text-lg mt-2 text-blue-700">Analyzing Image...</CardTitle>
              </CardHeader>
